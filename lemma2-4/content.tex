...
\begin{center}
    ...
    ]
  {
    ...
    \C((u))^p &
    \C((u))^p &
    \bigoplus_{\xi^p=1}\E^{\phi\circ\mu_\xi} &
    \mathbf{e} \\
    & \\
    & \\
    \partial_u e_i &
    ...
    \C((u))^p &
    \bigoplus_{\xi^p=1}\E^{\phi\circ\mu_\xi} &
    \mathbf{e}[\sum_{j=0}^{p-1}u^{j-1}\psi_jP^j]\\
    & ? & (...,0,1,0,...) & (...,0,1,0,...) & (...,0,1,0,...) \\
  };
    \path[->,font=\scriptsize,>=angle 90]
    (m-1-3) edge node[descr]{$\cong$} (m-1-2)
    (m-1-2) edge node[right]{$\partial_u$} (m-4-2)
    (m-4-3) edge node[descr]{$\cong$} (m-4-2)
    (m-1-4) edge node[above]{$T$} node[descr]{$\cong$} (m-1-3)
    (m-4-4) edge node[above]{$T$} node[descr]{$\cong$} (m-4-3)
    (m-1-3) edge node[descr]{$\sum_{j=0}^{p-1}u^{j-1}\psi_jP^j$} (m-4-3)
    (m-1-4) edge node[descr]{$\sum_{j=0}^{p-1}u^{j-1}\psi_jD^j$} (m-4-4)
    (m-1-4) edge node[descr]{$\cong$} (m-1-5)
    (m-4-4) edge node[descr]{$\cong$} (m-4-5)
    (m-1-5) edge node[right]{$\partial_u$} (m-4-5)
    ;
