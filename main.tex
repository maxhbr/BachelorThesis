...
\newcommand{\myNewNewtonPlot}[1]{
  % #1 sind die Punkte

  \pgfmathparse{#1[3]} \pgmathresult
...
\input{elem-mer-zsh.tex}

\input{levelt-turrittin.tex}
...
\input{anhang-lemma2-4.tex}

\input{anhang-plot-newton-polygon.tex}
