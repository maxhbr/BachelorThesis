...
\subsection{Levelt-Turittin-Zerlegung für $\phi_1$}
\begin{comment}
...
&= \cD_{\hat L}/\cD_{\hat L}\cdot(a-t^3\partial_t
  -\frac{1}{4}t^6(t^{-1}\overbracket{(t^{-1}\partial_t +
  [\partial_t,t^{-1}])}\partial_t))\\
&= \cD_{\hat L}/\cD_{\hat L}\cdot(a-t^3\partial_t
  -\frac{1}{4}t^6(t^{-1}(t^{-1}\partial_t -t^{-2})\partial_t))\\
&= \cD_{\hat L}/\cD_{\hat L}\cdot(a-t^3\partial_t
