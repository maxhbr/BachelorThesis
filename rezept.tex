...
einen Slope hat. Genau diesen Sonderfall möchten wir, um mit Satz
...
\\&\overset{!}{=} \partial_t^2 - (t^{-1} - 2i\sqrt{2a}t^{-2})\partial_t
  - 3 i\sqrt{2a}t^{-3} \,.
\end{align*}
Damit haben wir ein Ergebnis, das sich nun koeffizientenweise mit der
gewünschten Formel vergleichen lässt:
\begin{align}
...
Nun wollen wir in diesem Abschnitt noch das Konvergenzverhalten
betrachten.
Dieses Beispiel wurde auch schon in einem Brief von Takuro Mochizuki an
Giovanni Morando angesprochen. Demnach wurde mittels Monodromiebetrachtung
gezeigt, dass die Zerlegung nicht konvergent möglich ist.
Nichtsdestotrotz wollen wir dies hier trotzdem weiter untersuchen. Das Werkzeug
der Wahl hierfür ist, zwei klassische Konvergenzkriterien mit dem Computer zu
\glqq{}prüfen\grqq{}. Natürlich darf man hier dann nicht von einem Beweis der
...
Polynome $v(t)$ und $u(t)$ divergieren, also in $\hat L\backslash L$ liegen.
\begin{figure}[htbp]
  \centering
