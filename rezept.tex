...
\partial_t^2(e\otimes 1) 
  ...
  &= (\partial_t^2 e)\otimes 1
    ...
    + e\otimes\underset{\in K}{\underbrace{((\psi'(t))' + \psi'(t)\psi'(t))}}\\
  &= (\partial_t^2 e)\otimes 1
    + \overbracket{\underbracket{2\psi'(t)} (\partial_t e)\otimes 1}
    + (\underbracket{\psi''(t)} + \underbracket{\psi'(t)^2})e\otimes 1\\
  &= (\partial_t^2 e)\otimes 1
    + \overbracket{4i\sqrt{2a}t} (\partial_t e)\otimes 1
    + (\overbracket{2i\sqrt{2a}} + \overbracket{(2i\sqrt{2a}t)^2})e\otimes 1\\
  &= (\partial_t^2 e)\otimes 1
    + 4i\sqrt{2a}t (\partial_t e)\otimes 1
    + (2i\sqrt{2a} - 8at^2)e\otimes 1\\
\end{align*}
\begin{comment}
\begin{align*}
