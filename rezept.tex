...
Unser nächstes Ziel ist es, $\cN=\cD_{\hat L}/\cD_{\hat L}\cdot P'$ in zwei
...
\[
\rho^+\cM_{\phi} = \Bigg(\cD_{\hat L}/\cD_{\hat L}\cdot \Big(\partial_t
  + \sum_{n=-1}^\infty v_nt^n\Big)\otimes\sE^{-\psi(t)}\Bigg)
  \oplus \Bigg(\cD_{\hat L}/\cD_{\hat L}\cdot \Big(\partial_t
