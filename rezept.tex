...
\end{cases}
\end{equation}
\textbf{also für $\phi_1:=\frac{a}{x}$} ist
\begin{align*}
P_{\phi_1} &=1-a\frac{1}{x}\underbracket{(x^2\partial_x)^{2}}\\
           &\overbox{=}{(\ref{eq:rezeptNeben1})}1+a\frac{1}{x}
             \overbracket{(2x^3\partial_x-x^4\partial_x^2)}\\
           &=1-2x^2\partial_x-x^{3}\partial_x^2\\
P_{\phi_1} &=1-ax\underbracket{\partial_xx^2}\partial_x\\
           &\overbox{=}{(\ref{eq:rezeptNeben1})}
             1-ax\overbracket{(2x + x^2\partial_x)}\partial_x\\
           &=1-2ax^2\partial_x - ax^3\partial_x^2\\
\end{align*}
\begin{figure}[H]
...
\textbf{also für $\phi_2:=\frac{1}{x^2}$} ist
\begin{align*}
