...
\end{align*}
\begin{lem}
Sei $e$ ein zyklischer Vektor zu $\rho^+\cM_\phi$, so ist $e\otimes e(R)\in\cN$
ein zyklischer Vektor für $\cN\bydef\rho^+\cM_\phi\otimes\sE_{\hat K}^\psi$.
\end{lem}
\begin{proof}
\begin{comment}
Vergleiche mit Hedwigs Diplomarbeit Seite 37
\end{comment}
\end{proof}
\begin{lem}
