...
P_{\phi}(x,\partial_x) &=\cF_Q(x^{-1},-x^2\partial_x) \\
                       ...
                       &=\overbracket{(-x^2\partial_x)^{\max(I)}
                         \underbracket{x^2\partial_xx^{-1}}}
                         +\sum_{k\in I}k a_k(-x^2\partial_x)^{\max(I)-k} \\
                       &=(-x^2\partial_x)^{\max(I)}
                         \underbracket{
                           \overbracket{x^2(x^{-1}\partial_x-x^{-2})}
                         }
                         +\sum_{k\in I}k a_k(-x^2\partial_x)^{\max(I)-k} \\
                       &=(-x^2\partial_x)^{\max(I)}
...
$\rho^+\cM$ ist.
Es existieren $a_0(t)$ und $a_1(t)$ in $\hat L$, so dass
\[
...
P' &= t^4\partial_t^2 - (t^{3} + 2\psi'(t)t^4)\partial_t
    + \psi'(t)t^3 + 2a -\psi''(t)t^4
    + \psi'(t)^2t^4
\\&= t^4\partial_t^2 - (t^{3} + 2i\sqrt{2a}t^{2})\partial_t - i\sqrt{2a}
    + 2a - 2i\sqrt{2a}t + \underbracket{(-i\sqrt{2a}t^{-2})^2}t^4
\\&= t^4\partial_t^2 - (t^{3} + 2i\sqrt{2a}t^{2})\partial_t - 3 i\sqrt{2a}
    + 2a \overbracket{- 2at^{-4}}t^4
\\&= t^4\partial_t^2 - (t^{3} + 2i\sqrt{2a}t^{2})\partial_t - 3 i\sqrt{2a}
\end{align*}
\begin{figure}[H]
...
Also:
\begin{align*}
\sum_n (v_n-u_n)t^n&=t^{-1}-3i\sqrt{a}t^{-2}
&\mbox{ und } &&
\sum_n(u_{n-1}(n-1)+\sum_{k=0}^nv_nu_{k-n})t^n&=-3i\sqrt{a}t^{-3}
\end{align*}
müssen gelten.
