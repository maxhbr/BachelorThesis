...
\begin{thm}
Ein meromorpher Zusammenhang bestimmt einen holonomen lokalisierten\linebreak
...
\partial^d m&= \alpha_{d-1}\partial^{d-1}m + \alpha_{d-2}\partial^{d-2}m
  + \cdots + \alpha_1\partial m + \alpha_0m \,, \qquad \alpha_i\in K
\end{align*}
eine Basisdarstellung von $\partial^dm$, dann ist
\begin{align*}
\cM_K\cong
\cD_K/\cD_K\Big( \underset{=:P\in\cD_K}{\underbrace{
  \partial_x^d-\alpha_{d-1}\partial_x^{d-1}-\alpha_{d-2}\partial_x^{d-2}
  - \cdots - \alpha_1\partial_x - \alpha_0 }} \Big)\,,
\end{align*}
also $P=\partial_x^d-\alpha_{d-1}\partial_x^{d-1} - \cdots - \alpha_1\partial_x
- \alpha_0$ ein Minimalpolynom.
\begin{comment}
...
H(P):&=\underset{m,l\mbox{ \footnotesize mit }\alpha_{ml}\neq0}{\bigcup}
  \Big( (m,l-m) + \R_{\leq 0}\times \R_{\geq 0} \Big) \\
  &=\underset{m\mbox{ \footnotesize mit }a_{m}\neq0}{\bigcup}
  \Big( (m,deg(a_m)-m) + \R_{\leq 0}\times \R_{\geq 0} \Big)
    \qquad \subset \R^2 \,.
\end{align*}
...
auf eine andere Weise. Er schreibt $P=\sum_{k=0}^n a_k(x)(x\partial_x)^k$
...
H'(P):=\underset{m\mbox{ \footnotesize mit }a_{m}\neq0}{\bigcup}
  \Big( (m,deg(a_m)) + \R_{\leq 0}\times \R_{\geq 0} \Big)\qquad\subset \R^2 \,.
\]
...
\item P heißt \emph{regulär singulär} oder nur \emph{regulär}
$:\Leftrightarrow$ $\cP(P)=\{0\}$ oder $\deg P=0$, sonst \emph{irregulär
  singulär}.
\item Ein meromorpher Zusammenhang $\cM_{\hat K}$ (bzw. $\cM_K$) heißt 
\emph{regulär singulär}, falls es ein regulär singuläres $P\in \cD_{\hat K}$
(bzw. $P\in \cD_K$) gibt, mit $\cM_{\hat K}\cong\cD_{\hat K}/\cD_{\hat K}\cdot
P$ (bzw.
\linebreak
$\cM_K\cong\cD_K/\cD_K\cdot P$).
\end{itemize}
...
Das Newton-Polygon zu $P_2$ wurde in Abbildung \ref{fig:Newton-Polygon2}
visualisiert.
...
=H(\epsilon x^{p}\partial_x^{q})
\end{align*}
und damit folgt, dass $N(P)=N(\epsilon x^{p}\partial_x^{q})$ ist.
...
Elementen\linebreak $a,b\in\cD_{\hat K}$ nur Elemente im gemeinsamen Quadranten
auftauchen. Es gilt also
\begin{equation} \label{eq:commuteInNP}
