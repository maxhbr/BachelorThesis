...
\begin{enumerate}
\item Ein besonders einfaches Beispiel ist $P_1=t\partial_t^2$.
Es ist leicht abzulesen, dass
\begin{align*}
...
\]
Dies führt zu dem Newton Polygon, welches in Abbildung
\ref{fig:Newton-Polygon1} gezeichnet
ist.
...
\myNewtonPlot{\myPoints}{\myPath}{4}{-2}{2}{$N(P_1)$}
\end{tikzpicture}
}
\quad
...
\subfloat[Newton Polygon zu $P$]{
  ...
  \myNewtonPlot{\myPoints}{\myPath}{2}{0}{3}{$N(P)$}
  \end{tikzpicture}
}
\quad
