...
Der Meromorphe Zusammenhang. $\frac{d}{dz}+A$ auf $K^r$ wird durch Basiswechsel
$T\in GL(r,K)$ zu
\[
...
\end{tikzpicture}
\end{center}
Nun ist aber bekannt, dass Kokerne isomorpher Abbildungen ebenfalls isomorph
sind. Damit folgt die Behauptung
\begin{comment}
