...
\end{tikzpicture}
\end{center}
ist \textbf{exact}, weil $\cM\cong\myT\Big/\myT\cdot P=\coker(\_\cdot P)$.
Weil $\Cful$ \textbf{flach} ist, da  Körper, ist auch, nach anwenden von
$\Cful\otimes_\Cftl\_$, die Sequenz
...
\[
\phi:\rho^*\cM = \Cful\otimes_\Cftl(\cD_\Cftl\slash\cD_\Cftl\cdot P)\rightarrow \myU\Big/\myU\cdot Q
\]
 finden. Sei dazu
$x\in\rho^*\cM$, weil die Abbildung $\pi$ surjektiv ist, existiert ein
$y\in\Cful\otimes_{\Cftl}\myT$ mit $\pi(x)=y$.
\begin{comment}
