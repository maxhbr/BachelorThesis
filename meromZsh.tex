...
\begin{center}
\begin{tikzpicture}
%TODO: achsbeschriftung?
%\draw[very thin,color=gray,opacity=.2] (-0.4,-2.1) grid (4.6,2.1);
\draw[->] (-0.5,0) -- (4.7,0);
\draw[->] (0,-2.2) -- (0,2.2);

\draw[color=black,thick] (-0.5,-2) -- (1,-2) -- (4,0) --
node[right] {$N(P)$} (4,2);

\fill[blue,opacity=.3] (-0.5,2) rectangle (0,0);
\fill[blue,opacity=.3] (-0.5,2) rectangle (4,0);
\fill[blue,opacity=.3] (-0.5,2) rectangle (2,-1);
\fill[blue,opacity=.3] (-0.5,2) rectangle (1,-2);
\end{tikzpicture}
\end{center}
\end{figure}
\end{exmp}
...
\subfloat[Newton Polygon zu $P$]{
  ...
  \draw[color=black,thick] (-0.5,0) -- (0,0) -- (2,1) --
  node[right] {$N(P)$} (2,3.0);

  \fill[blue,opacity=.3] (-0.5,3) rectangle (0,0);
  \fill[blue,opacity=.3] (-0.5,3) rectangle (1,1);
  \fill[blue,opacity=.3] (-0.5,3) rectangle (2,1);
  \end{tikzpicture}
}
\quad
\subfloat[Newton Polygon zu $\rho^+P$]{
  ...
  \draw[color=black,thick] (-0.5,0) -- (0,0) -- (2,2) --
  node[right] {$N(\rho^+P)$} (2,3.0);

  \fill[blue,opacity=.3] (-0.5,3) rectangle (0,0);
  \fill[blue,opacity=.3] (-0.5,3) rectangle (1,2);
  \fill[blue,opacity=.3] (-0.5,3) rectangle (2,2);
  \end{tikzpicture}
}
\end{center}
\end{figure}
...
\subfloat[Newton Polygon zu $P$]{
  ...
  \draw[color=black,thick] (-0.5,-3) -- (0,-3) -- (1,-1)
  node[right] {$N(P)$} -- (1,1);

  \fill[blue,opacity=.3] (-0.5,1) rectangle (0,-3);
  \fill[blue,opacity=.3] (-0.5,1) rectangle (1,-1);
  \end{tikzpicture}
}
\quad
\subfloat[Newton Polygon zu $\rho_+P$]{
  ...
  \draw[color=black,thick] (-0.5,-2) -- (0,-2) -- (1,-1)
  node[right] {$N(\rho_+P)$} -- (1,1);

  \fill[blue,opacity=.3] (-0.5,1) rectangle (0,-2);
  \fill[blue,opacity=.3] (-0.5,1) rectangle (1,-1);
  \end{tikzpicture}
}
\end{center}
