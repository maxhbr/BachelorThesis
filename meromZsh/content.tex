...
\begin{thm} 
  ...
  Ein Meromorpher Zusammenhang bestimmt ein holonom lokalisiertes $\cD$-Modul
  und andersherum.
\end{thm}
\begin{proof}
  \cite[Thm 4.3.2]{sabbah_cimpa90}
...
\begin{lem} 
  ...
  Sei $\cM_K$ ein Meromorpher Zusammenhang, dann existiert ein $P\in\cD_K$ so dass
