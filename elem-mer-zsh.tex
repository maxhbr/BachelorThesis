...
Sei $\phi\in\hat K$.
Wir schreiben $\sE_{\hat K}^\phi$ für den (formalen) Rang 1 Vektorraum $\Cfxl \bydef
...
\end{defn}
\begin{bem}
Auf die Angabe von des Rang 1 Vektorraums im Subscript wird im folgendem meist
verzichtet.
\end{bem}
