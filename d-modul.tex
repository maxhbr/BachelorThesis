...
Wir werden als Körper $k$ immer ein Element aus $\{ \C[x],\Ckx,\Cfx,K,\hat K
\}$ betrachten.
...
[\partial_x,f]\cdot g=\partial_x(fg)-f\partial_xg=
  ...
  (\partial_xf)g \,.
\]
\item Siehe \cite[1.2.4.]{sabbah_cimpa90}
\end{enumerate}
\end{proof}
...
\begin{defn}
Ein lokalisiertes $\cD$-Modul $\cM$ heißt \emph{holonom}, falls es ein
